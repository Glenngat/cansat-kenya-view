...
import { Mountain, Wind, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background text-foreground dark">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-3xl font-bold text-white">Mission 1 - Primary Flight</h1>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="h-[600px]">
              <CardHeader>
                <CardTitle className="text-xl text-white">Mission 1 Data - Orientation & Velocity</CardTitle>
              </CardHeader>
